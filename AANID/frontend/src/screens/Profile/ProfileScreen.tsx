...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: COLORS.primaryDark, paddingTop: 52, paddingBottom: 40,
    alignItems: 'center', borderBottomLeftRadius: 32, borderBottomRightRadius: 32,
  },
  topRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    width: '100%', paddingHorizontal: 20, marginBottom: 14,
  },
  ...
  avatar: {
    width: 84, height: 84, borderRadius: 42, backgroundColor: 'rgba(255,255,255,0.20)',
    justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: 'rgba(255,255,255,0.32)',
  },
  avatarText: { color: COLORS.white, fontSize: 34, fontWeight: 'bold', fontFamily: FONT_FAMILY },
  editAvatar: {
  ...
  name: { color: COLORS.white, fontSize: 21, fontWeight: '700', fontFamily: FONT_FAMILY },
  email: { color: 'rgba(255,255,255,0.7)', fontSize: 13, marginTop: 3, fontFamily: FONT_FAMILY },
  badge: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.16)',
    paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999, marginTop: 14,
  },
