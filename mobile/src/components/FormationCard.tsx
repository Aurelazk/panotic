...
const FormationCard: React.FC<FormationCardProps> = ({ formation, onPress }) => {
  return (
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.9}>
      <ImageBackground source={{ uri: formation.imageUrl }} style={styles.image}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>{formation.capacity - formation.enrolledCount} places restantes</Text>
          </View>
        </View>
      </View>
    </TouchableOpacity>
