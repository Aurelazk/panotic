...
const AdminDashboardScreen = () => {
  ...
  const exportCSV = async () => {
    try {
      ...
      Share.share({
        message: res.data.csv || 'Fichier CSV Panotic',
        title: 'Export Panotic CSV',
        url: Platform.OS === 'ios' ? res.data.url || '' : undefined,
      });
    } catch (e) {
                ...
                <View style={styles.userCard}>
                  ...
                  <View style={styles.userActions}>
                    ...
                    <TouchableOpacity style={[styles.smallBtn, {backgroundColor: '#4CAF50'}]} onPress={() => assignBadge(item.id, 'Super Citoyen')}>
                      <Text style={styles.smallBtnText}>Badge Super Citoyen</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              )}
