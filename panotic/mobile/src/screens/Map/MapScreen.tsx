...
import { Marker, Callout, Polygon, Region, UrlTile } from 'react-native-maps';
          ...
          <View style={styles.modalContent}>
            ...
            {selectedPanel && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Image source={{ uri: selectedPanel.imageUrl || 'https://via.placeholder.com/300x150?text=Panneau' }} style={styles.modalImage} />
