...
exports.submitBillboard = void 0;
const db_1 = __importDefault(require("../config/db"));
const submitBillboard = async (req, res) => {
    try {
    ...
    `;
        ...
        const { rows: duplicates } = await db_1.default.query(duplicateCheckQuery, [lng, lat]);
    ...
    `;
        const { rows: inserted } = await db_1.default.query(insertQuery, [
            userId,
            type,
            size,
            imageUrl,
...
exports.submitBillboard = submitBillboard;
